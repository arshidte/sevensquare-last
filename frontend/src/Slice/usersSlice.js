...
export const getRejectedUser = createSlice({
  name: "getRejectedUser",
  initialState: {
    loading: false,
    data: [],
    error: false,
...
export const addNewUser = createAsyncThunk("addNewUser", async (user) => {
  const response = await axios.post(`${URL}/api/users/add-user-to-all`, {
...
export const getRejectedReducer = getRejectedUser.reducer;
